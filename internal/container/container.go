...
func BuildContainer(container *dig.Container) *dig.Container {
	...
	must(container.Provide(repository.NewStudioArtifactRepository))
	...
	must(container.Provide(service.NewStudioArtifactService))
	...
	must(container.Provide(handler.NewStudioArtifactHandler))
